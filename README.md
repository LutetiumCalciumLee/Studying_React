...
This branch contains notes and practice code covering JSX syntax, styling, conditional rendering, React components, component lifecycle, state, props, and reusable component design.
...
이 Branch에서는 JSX의 기본 문법과 스타일 적용, 조건부 렌더링, React 컴포넌트의 개념과 설계, State와 Lifecycle, Props를 이용한 컴포넌트 재사용을 학습했습니다.
